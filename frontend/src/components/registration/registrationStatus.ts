...
> = {
  ...
  sang: {
    label: 'Sáng',
    shortLabel: 'Sáng',
    className: 'bg-status-sang text-status-sang-foreground',
  },
  ...
  off: {
    label: 'Không làm (N)',
    shortLabel: 'N',
    className: 'bg-status-off text-status-off-foreground',
  },
  leave: {
    label: 'Nghỉ phép',
    shortLabel: 'Nghỉ',
    className: 'bg-status-leave text-status-leave-foreground',
  },
};
